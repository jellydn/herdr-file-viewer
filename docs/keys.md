...
_does_, see the [usage guide](usage.md); to remap any of these keys, see
...
| `d`                   | **Directory diff** (toggle): show all changes under the selected directory (or the parent of a selected file) as a unified diff; press again to return to the normal view                                                                                                                                                                                                                                                                                                               |
...
_not_ from the shell you happen to be attached from. So if `$EDITOR` is set in your interactive
...
3. **Verify:** open any shell pane _inside_ herdr and run `echo $EDITOR`. Once that prints your
